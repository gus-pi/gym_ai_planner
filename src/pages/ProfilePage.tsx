            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-4 gap-4 mb-8">
                    <Card variant="bordered" className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs font-semibold text-muted">Goal</p>
                            <p className="font-medium text-sm text-white">{plan.overview.goal}</p>
                        </div>
                    </Card>
                    <Card variant="bordered" className="flex items-center gap-3">
                        <div className="w-10 h-10 flex items-center justify-center">
                        ...
                        <div>
                            <p className="text-xs font-semibold text-muted">Frequency</p>
                    ...
                    <Card variant="bordered" className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs font-semibold text-muted">Split</p>
                            <p className="font-medium text-sm text-white">{plan.overview.split}</p>
                        </div>
                    </Card>
                    <Card variant="bordered" className="flex items-center gap-3">
                        <div className="w-10 h-10 flex items-center justify-center">
                        ...
                        <div>
                            <p className="text-xs font-semibold text-muted">Version</p>
                            <p className="font-medium text-sm text-white">{plan.version}</p>
                        </div>
                    </Card>
                </div>
                ...
                <Card variant="bordered" className="mb-8">
                    <h2 className="text-lg mb-2 font-bold text-white">Program Notes</h2>
                ...
                <Card variant="bordered" className="mb-8">
                    <h2 className="font-semibold text-lg mb-2 text-white">Progression Strategy</h2>
